      ...
      if (mobile) {
        return (
          <div className={Styles.container}>
            ...
            <span>Por favor intenta abrir la página con otro navegador. Si no funciona <a className={Styles.link} href="mailto:contacto@brigada.mx" target="_blank" rel="noopener noreferrer">favor de contactarnos</a>.</span>
          </div>
        )
      }
